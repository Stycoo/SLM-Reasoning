...
gt_last_segment_completion_inputs = []
gt_last_segment_completion_ids = []
...
for data in input_data:
    ...
    for i, part in enumerate(parts):
        if part:
            ...
            gt_last_segment_completion_inputs.append(f"{prompt_normal}{answer}")
            gt_last_segment_completion_ids.append(len(parts))
...
for i, output in enumerate(outputs):
    ...
    gt_last_segment_completion_input = gt_last_segment_completion_inputs[i]
    gt_last_segment_completion_id = gt_last_segment_completion_ids[i]
    ...
    if prompt in output_data:
        ...
        output_data[prompt] = {'prompt': prompt, 'answer': answer, 'completion_inputs': [completion_input, gt_last_segment_completion_input], 
                                'completion_outputs':[generated_text, answer], 
                                'completion_inputs_id': [completion_input_id, gt_last_segment_completion_id]}  
