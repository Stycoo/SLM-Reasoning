...
for i, output in enumerate(outputs):
    ...
    prefix_label = prefix_labels[i]
    output_data[prompt] = {'prompt': prompt, 'answer': answer, 'completion_inputs': [completion_input, completion_input], 
                           'completion_outputs':[prefix_label, generated_text]}
