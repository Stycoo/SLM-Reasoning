...
# Default values
MODEL_ROOT_DIR=/GLOBALFS/gznwp_3/qxj/shitianyuan/Model-Fusion/saves/model_fusion/FuseChat-Llama-3.2-3B-SFT/0412/iterative_updated_coarse_adv_based_misalign_dpo # iteration_order_ablation_2
...
OUTPUT_ROOT_DIR=/GLOBALFS/gznwp_3/qxj/shitianyuan/Model-Fusion/benchmark_inference_results/FuseChat-Llama-3.2-3B-SFT/0412/iterative_updated_coarse_adv_based_misalign_dpo
