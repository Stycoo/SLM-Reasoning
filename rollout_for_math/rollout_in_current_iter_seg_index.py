...
for data in input_data:
    ...
    part_size = len(completion_steps) // (args.segment_num)
    remainder = len(completion_steps) % (args.segment_num)
    ...
    elif args.forward_or_reverse == 'reverse':
        completion_input = '\n\n'.join(parts[: -args.completion_id])
    else:
        raise ValueError("Invalid value for --forward_or_reverse. It should be 'forward' or 'reverse'.")
