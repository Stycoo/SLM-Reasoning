...
# Default values
MODEL_ROOT_DIR="$PROJ_DIR/saves/model_fusion/$MODEL_ID/$DATA/$VERSION/seg_1"
OUTPUT_ROOT_DIR="$PROJ_DIR/benchmark_inference_results/$MODEL_ID/$DATA/$VERSION/seg_1"
