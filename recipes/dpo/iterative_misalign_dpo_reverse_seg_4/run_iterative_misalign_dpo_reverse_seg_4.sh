...
VERSION='iterative_misalign_dpo_reverse_seg_4'
ITERATION_TIME=4
...
do  
    ...
    #         CUDA_VISIBLE_DEVICES=$GPU python $PROJ_DIR/completion_inference/completion_infer_in_specific_index_include_last_step.py \
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 FORCE_TORCHRUN=1 llamafactory-cli train \
        "$PROJ_DIR/recipes/dpo/iterative_misalign_dpo_${FORWARD_OR_REVERSE}_seg_4/iter_$i.yaml" > "$LOG_FILE" 2>&1
