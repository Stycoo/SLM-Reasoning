...
LOG_DIR=$PROJ_DIR/log/0322
mkdir -p $LOG_DIR
exec > $LOG_DIR/run_openr1_solution_hard_sft_bs_64.log 2>&1

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 FORCE_TORCHRUN=1 llamafactory-cli train $PROJ_DIR/recipes/sft/llama3_full_sft_ds3_cp.yaml