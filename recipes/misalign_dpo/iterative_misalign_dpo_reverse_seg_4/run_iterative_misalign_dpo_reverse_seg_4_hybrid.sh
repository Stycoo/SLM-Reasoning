...
do  
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 FORCE_TORCHRUN=1 llamafactory-cli train \
        "$PROJ_DIR/recipes/misalign_dpo/iterative_misalign_dpo_${FORWARD_OR_REVERSE}_seg_4/iter_${i}_hybrid.yaml" > "$LOG_FILE" 2>&1
...
MODEL_NAMES=(iter_2_hybrid_dpo) # iter_2 iter_3
DATATYPES=(aime)
N=(16)
