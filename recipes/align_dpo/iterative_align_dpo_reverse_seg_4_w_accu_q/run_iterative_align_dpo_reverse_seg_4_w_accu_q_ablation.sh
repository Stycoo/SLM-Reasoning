...
VERSION='iterative_align_dpo_reverse_seg_4_w_accu_q'
ITERATION_TIME=3
SEGMENT_NUM=4
...
do  
    ...
    # /GLOBALFS/gznwp_3/qxj/models/$MODEL_ID
    ...
    LOG_FILE="${TRAINING_LOG_DIR}/run_dpo_iter_${i}_ablation.log"
...
MODEL_NAMES=(iter_3_ablation) # iter_2 iter_3
DATATYPES=(aime)
N=(16)
